        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-8 hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className={`text-xs font-black uppercase tracking-wider px-4 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] inline-block text-center ${roleBadge.cls}`}>
                {roleBadge.label}
              </span>
            </div>
          </div>
          ...
          <div className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] p-8 hover:-translate-y-1 hover:-translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
            ...
            <div className="flex flex-col gap-3">
              ...
              <span className={`text-xs font-black uppercase tracking-wider px-4 py-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] inline-block text-center ${statusCls}`}>
                {user.status}
              </span>
            </div>
          </div>
