...
export function HeroActionButtons() {
  ...
  if (!clerkLoaded || loading || (isSignedIn && !user)) {
    return (
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-6 w-full max-w-md sm:max-w-none mx-auto">
        <div className="w-full sm:w-56 h-14 sm:h-[60px] bg-gray-200 border-4 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] animate-pulse"></div>
        <div className="w-full sm:w-56 h-14 sm:h-[60px] bg-gray-200 border-4 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] animate-pulse"></div>
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-6 w-full max-w-md sm:max-w-none mx-auto">
        <StudentSignupButton 
          className="w-full sm:w-auto min-h-14 px-5 sm:px-8 py-3 sm:py-4 bg-emerald-400 hover:bg-emerald-500 text-black font-black uppercase tracking-wide sm:tracking-wider text-base sm:text-xl border-4 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-transform active:translate-y-1.5 active:translate-x-1.5 active:shadow-none"
        >
          Học với StudyMate
        </StudentSignupButton>
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 sm:gap-6 w-full max-w-md sm:max-w-none mx-auto">
      <Link 
        href="/dashboard"
        className="w-full sm:w-auto min-h-14 px-5 sm:px-8 py-3 sm:py-4 bg-emerald-400 hover:bg-emerald-500 text-black font-black uppercase tracking-wide sm:tracking-wider text-base sm:text-xl border-4 border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] sm:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-transform active:translate-y-1.5 active:translate-x-1.5 active:shadow-none inline-flex items-center justify-center"
      >
        Dashboard
      </Link>
